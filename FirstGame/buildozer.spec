...
title = SkylineFirstApp

# (str) Package name
package.name = SkyFirstApk

# (str) Package domain (needed for android/ios packaging)
package.domain = com.SkyFirstApk
...
requirements = python3==3.10.12,kivy==2.3.0,hostpython3==3.10.12,pyjnius==1.5.0, pygame,jnius,sdl2,sdl2_image,sdl2_mixer,sdl2_ttf,png,jpeg,pygame-menu,typing-extensions
...
presplash.filename = %(source.dir)s/images/my_icon.png

# (str) Icon of the application
icon.filename = %(source.dir)s/images/my_icon.png
